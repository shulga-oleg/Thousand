...
public class ConnectionFrame extends javax.swing.JFrame {
    ...
    private ClientFrame _super;
    
    public ConnectionFrame() {
        this.connectFile = new File("connect.txt");
        initComponents();
    }
    
    public void setSettings(ClientFrame generalFrame) {
        _super = generalFrame;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        writeFile = new FileWriter(connectFile, false);
        writeFile.append(jTextField1.getText()+"\n");
        writeFile.append(jTextField2.getText()+"\n");
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
            if(writeFile != null) {
